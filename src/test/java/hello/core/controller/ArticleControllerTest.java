...
class ArticleControllerTest {
    ...
    // User 정보를 Mocking
    // 컨트롤러에서 인증된 실제 유효한 유저 정보로 추가 가공하지 않는 선에서 가능!(수정, 삭제에선 불가능)
    @WithMockUser
    ...
    /*
    TestSecurityConfig 에 저장된 가상의 User 정보를 Mocking
    TestExecutionEvent.TEST_EXECUTION => 테스트를 실행하기 직전에 SetUp
     */
